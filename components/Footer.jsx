                ...
                <div className="flex items-start group">
                  <div className="flex-shrink-0 w-14 h-14 bg-[#e8c74f]/10 border-2 border-[#e8c74f]/30 flex items-center justify-center group-hover:bg-[#e8c74f]/20 group-hover:border-[#e8c74f] transition-all duration-300">
                   ...
                   <div className={`${isRTL ? 'mr-4' : 'ml-4'}`}>
                     ...
                     <a href="tel:+966552514044" className="text-white font-semibold hover:text-[#e8c74f] transition-colors duration-300 block">+966 552514044</a>
                     <a href="tel:+966566722297" className="text-white font-semibold hover:text-[#e8c74f] transition-colors duration-300 block">+966 566722297</a>
                   </div>
                </div>
